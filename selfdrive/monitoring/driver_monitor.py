...
class DriverStatus():
    def __init__(self, rhd=False, settings=DRIVER_MONITOR_SETTINGS()):
        ...
        self.hi_stds = 0
        self.threshold_pre = self.settings._DISTRACTED_PRE_TIME_TILL_TERMINAL / \
            self.settings._DISTRACTED_TIME
        self.threshold_prompt = self.settings._DISTRACTED_PROMPT_TIME_TILL_TERMINAL / \
            self.settings._DISTRACTED_TIME
    ...
    def _set_timers(self, active_monitoring):
        ...
        if active_monitoring:
            ...
            self.threshold_prompt = self.settings._AWARENESS_PROMPT_TIME_TILL_TERMINAL / \
                self.settings._AWARENESS_TIME
    ...
    def update(self, events, driver_engaged, ctrl_active, standstill):
        ...
        standstill_exemption = standstill and self.awareness - \
            self.step_change <= self.threshold_prompt
